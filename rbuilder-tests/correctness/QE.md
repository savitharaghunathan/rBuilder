...
| Cross-feature consistency | `cargo test --test cross_feature_qe` (CALLS ↔ blast ↔ analysis_results ↔ macro_call_index ↔ semantic expand ↔ CFG) — C2/C3 currently required-red: [#28](https://github.com/sshaaf/rBuilder/issues/28) |
